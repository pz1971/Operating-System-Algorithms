...
void C_LOOK(const int number_of_heads, const vector<int> &requests, int pos, const int direction)
{
...
int main()
{
    ...
    cout << "C-LOOK (initial direction is left):" << endl ;
    C_LOOK(number_of_heads, requests, pos, LEFT) ;
    cout << "C-LOOK (initial direction is right):" << endl ;
    C_LOOK(number_of_heads, requests, pos, RIGHT) ;
